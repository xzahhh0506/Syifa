<?php
$judul = $_GET['judul'] ?? 'Peresmian Gedung Sekolah';
$isi = $_GET['isi'] ?? 'SMKN 64 Jakarta secara resmi meresmikan gedung barunya sebagai bagian dari upaya peningkatan sarana dan prasarana pendidikan demi mendukung proses belajar mengajar yang lebih optimal. Acara peresmian tersebut berlangsung meriah dan dihadiri oleh berbagai pihak penting, termasuk pejabat dari Dinas Pendidikan, tokoh masyarakat, serta Gubernur DKI Jakarta, Bapak Rono Karno, yang secara simbolis memotong pita sebagai tanda dimulainya penggunaan gedung baru tersebut. Kehadiran beliau beserta jajaran dinas menunjukkan komitmen pemerintah daerah dalam mendukung kemajuan pendidikan vokasi di Jakarta, khususnya dalam menciptakan lingkungan belajar yang lebih representatif dan modern bagi para siswa SMK.';
$gambar = $_GET['gambar'] ?? 'gambar1.jpg';
